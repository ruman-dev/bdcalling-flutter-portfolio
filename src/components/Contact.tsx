...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    sendMessage(formData as ContactMessage, {
      onSuccess: () => {
        toast({
          title: "Message Sent!",
    ...
    <section id="contact" className="py-20 bg-white dark:bg-slate-800">
      <div className="section-container">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-2 dark:text-white">Contact Me</h2>
          ...
          <div className="bg-blue-50 dark:bg-slate-700 p-8 rounded-xl">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-white dark:bg-slate-600 p-3 rounded-full shadow-sm mr-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="w-full min-h-[150px] dark:bg-slate-700 dark:border-slate-600 dark:text-white"
                />
              </div>
