    ...
    <footer className="bg-gray-900 text-white">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            {/* <div className="flex space-x-4">
              <a href={profile?.github} className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href={profile?.linkedin} className="text-gray-400 hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <button 
            onClick={scrollToTop}
            className="bg-primary/20 hover:bg-primary/30 text-white p-3 rounded-full transition-colors mt-4 md:mt-0"
