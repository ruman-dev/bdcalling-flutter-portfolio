...
const Hero = () => {
  return (
    <section id="home" className="relative bg-gradient-to-b from-blue-50 to-white dark:from-slate-900 dark:to-slate-800 pt-28 pb-20 md:pt-36 md:pb-32">
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative lg:pl-8 animate-fade-in">
            <div className="aspect-square rounded-full bg-blue-500/10 border-2 border-primary/20 dark:bg-blue-500/5 dark:border-blue-400/20 flex items-center justify-center">
              <div className="aspect-square w-[92%] rounded-full bg-blue-500/15 dark:bg-blue-500/10 border border-primary/30 dark:border-blue-400/30 flex items-center justify-center">
                <div className="aspect-square w-[85%] rounded-full bg-gradient-to-br from-blue-100 to-white dark:from-blue-900/30 dark:to-slate-800 shadow-lg flex items-center justify-center">
                  <img 
            ...
            <div className="absolute top-5 -right-4 md:top-10 md:right-0 bg-white dark:bg-slate-700 rounded-lg shadow-lg p-3 animate-bounce">
              <div className="bg-blue-50 dark:bg-slate-600 rounded p-1">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14.5 0.5L0.5 13.5L7.5 14.5L9.5 23.5L23.5 10.5L16.5 9.5L14.5 0.5Z" fill="#3B82F6"/>
                </svg>
              </div>
            </div>
            <div className="absolute bottom-5 -left-4 md:bottom-10 md:left-0 bg-white dark:bg-slate-700 rounded-lg shadow-lg p-3">
              <div className="bg-blue-50 dark:bg-slate-600 rounded p-1">
